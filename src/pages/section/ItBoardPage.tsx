...
import { itCategories } from "../../data/_data";
...
export default function ItBoardPage() {
    ...
    useEffect(() => {
        const fetchPosts = async () => {
            try {
                ...
                console.error("IT 게시글을 불러오는 데 실패했습니다.", error);
            }
        };
    ...
    return <Board boardData={posts} categories={itCategories} boardType="it" />;
}
